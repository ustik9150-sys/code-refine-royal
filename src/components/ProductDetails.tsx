    ...
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border lg:hidden">
        ...
        <div className="flex gap-2 px-2 py-2">
          <button className="flex-1 py-2.5 bg-foreground text-background font-bold text-xs flex items-center justify-center gap-2">
            <ShoppingCart className="w-3.5 h-3.5" />
            <span>إضافة للسلة</span>
          </button>
          <button className="flex-1 py-2.5 bg-background text-foreground font-bold text-xs flex items-center justify-center gap-2 border border-foreground/80">
