...
const SENDER_DOMAIN = "notify.saqrix.shop"
const ROOT_DOMAIN = "saqrix.shop"
const FROM_DOMAIN = "saqrix.shop" // Domain shown in From address (may be root or sender subdomain)
